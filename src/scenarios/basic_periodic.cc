...
Template(RoutingType routing) {
  ...
  general.initial_sequential_addresses = true;
  ...
  sarp_parameters.neighbor_cost = {.mean = 1, .sd = 0.1, .group_size = 1};
  sarp_parameters.reflexive_cost = {.mean = 0, .sd = 0, .group_size = 1};
...
SpreadOut_Static_Periodic(RoutingType routing, Parameters::Sarp sarp_settings) {
  ...
  general.initial_sequential_addresses = false;
