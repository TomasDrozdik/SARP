...
#ifndef SARP_SRC_SIMULATION_NETWORK_GENERATOR_ADDRESS_ITERATOR_H_
#define SARP_SRC_SIMULATION_NETWORK_GENERATOR_ADDRESS_ITERATOR_H_
...
#endif  // SARP_SRC_SIMULATION_NETWORK_GENERATOR_ADDRESS_ITERATOR_H_
