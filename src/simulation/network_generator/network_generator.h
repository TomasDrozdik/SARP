...
#ifndef SARP_SRC_SIMULATION_NETWORK_GENERATOR_NETWORK_GENERATOR_H_
#define SARP_SRC_SIMULATION_NETWORK_GENERATOR_NETWORK_GENERATOR_H_
...
#endif  // SARP_SRC_SIMULATION_NETWORK_GENERATOR_NETWORK_GENERATOR_H_
