...
#ifndef SARP_SRC_SIMULATION_DISTANCE_VECTOR_ROUTING_DV_PACKET_H_
#define SARP_SRC_SIMULATION_DISTANCE_VECTOR_ROUTING_DV_PACKET_H_
...
#endif  // SARP_SRC_SIMULATION_DISTANCE_VECTOR_ROUTING_DV_PACKET_H_
